...
public class FinderService {
	...
	public Collection<Film> search(Finder finder) {
		...
		minimumRating = (finder.getMinimumRating() == null) ? 0.0 : finder
				.getMinimumRating();
		maximumRating = (finder.getMaximumRating() == null) ? 10.0 : finder
				.getMaximumRating();
		maximumDuration = (finder.getMaximumDuration() == null) ? 1000 : finder
				.getMaximumDuration();
		...
		if ((finder.getKeyWord() == null || finder.getKeyWord().isEmpty())
			...
			results = this.finderRepository.search(keyWord, maximumDuration,
