		...
		<fieldset>
			...
			<div style="float: left;">
				...
				<div>
					...
					<jstl:out value="${moderator.surname}" />
				</div>
				...
				<div>
					...
					<jstl:out value="${moderator.email}" />
				</div>
				...
				<div>
					...
					<jstl:out value="${moderator.phoneNumber}" />
				</div>
				...
				<div>
					...
					<jstl:out value="${moderator.address}" />
				</div>

				<display:table pagesize="5" requestURI="${requestURI}"
					class="displaytag" name="${moderator.socialProfile}" id="profile">
			...
			<div style="float: right;">
				<img style="width: 200px; height: 200px" src="${moderator.photo}"
					alt="User photo">
			</div>
