		...
		<fieldset>
			...
			<div style="float: left;">
				<div>
					...
					<jstl:out value="${filmEnthusiast.name}" />
				</div>
				...
				<div>
					...
					<jstl:out value="${filmEnthusiast.surname}" />
				</div>
				...
				<div>
					...
					<jstl:out value="${filmEnthusiast.email}" />
				</div>
				...
				<div>
					...
					<jstl:out value="${filmEnthusiast.phoneNumber}" />
				</div>
				...
				<div>
					...
					<jstl:out value="${filmEnthusiast.address}" />
				</div>

				<display:table pagesize="5" requestURI="${requestURI}"
					class="displaytag" name="${filmEnthusiast.socialProfile}" id="profile">
			...
			<div style="float: right;">
				<img style="width: 200px; height: 200px" src="${filmEnthusiast.photo}"
					alt="User photo">
			</div>
