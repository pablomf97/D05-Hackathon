...
<security:authorize access="hasRole('CRITIC')">
	...
	<form:form modelAttribute="miscellaneousData"
		action="miscellaneousData/critic/edit.do?dataId=${miscellaneousData.id}&curriculaId=${currentCurricula.id}"
		id="form">
		...
		<acme:cancel
			url="miscellaneousData/critic/list.do?curriculaId=${currentCurricula.id}"
