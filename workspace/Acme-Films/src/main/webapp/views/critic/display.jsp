		...
		<fieldset>
			...
			<div style="float: left;">
				...
				<div>
					...
					<jstl:out value="${critic.phoneNumber}" />
				</div>
				...
				<div>
					...
					<jstl:out value="${critic.address}" />
				</div>

				<display:table pagesize="5" requestURI="${requestURI}"
					class="displaytag" name="${critic.socialProfile}" id="profile">
			...
			<div style="float: right;">
				<img style="width: 200px; height: 200px" src="${critic.photo}"
					alt="User photo">
			</div>
